				...
				<tr>
					<td id="navigation">
						...
						<div class="nav-contents">
							<ul>
								...
								<a href="customerchat.php"><li class="active"><i class="fa fa-comments-o" aria-hidden="true"></i> &nbsp Customer Chat</li></a>
					...
					<td id="main">
						...
						<div class="no-request">
							<i class="fa fa-exclamation-triangle" aria-hidden="true"></i> &nbsp No Chat Found
						</div>
					</td>
				</tr>
			</table>
