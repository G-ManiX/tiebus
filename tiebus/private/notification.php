				...
				<tr>
					<td id="navigation">
						...
						<div class="nav-contents">
							<ul>
								...
								<a href="notification.php"><li class="active"><i class="fa fa-globe" aria-hidden="true"></i> &nbsp Notification</li></a>
					...
					<td id="main">
						...
						<div class="no-request">
							<i class="fa fa-exclamation-triangle" aria-hidden="true"></i> &nbsp Nothing Found
						</div>
					</td>
				</tr>
			</table>
